      ...
      <div className="p-4 sm:ml-64 bg-gray-50 min-h-screen">
        ...
        <div className="p-6 bg-white shadow-sm rounded-lg">
          ...
          <ul className="mt-2 space-y-2 list-disc list-inside text-gray-600">
            ...
            <li>
              If you have the <strong>Delete</strong> permission, you can delete a user from the database.
            </li>
            <li>
              With <strong>Modify</strong> permission, you can edit user information.
            </li>
          </ul>
        </div>
      </div>
